...
class DrinkDetailsSearchSale extends StatefulWidget {

  final Drink _drink;

  DrinkDetailsSearchSale(this._drink);

  @override
  _DrinkDetailsSearchSaleState createState() => _DrinkDetailsSearchSaleState();
}

class _DrinkDetailsSearchSaleState extends State<DrinkDetailsSearchSale> {
